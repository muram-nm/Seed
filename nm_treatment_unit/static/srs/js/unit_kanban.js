...
import { UnitControlPanel } from '@nm_treatment_unit/js/unit_control_panel';
...
const UnitUnitKanbanRecord = KanbanRecord.extend({
    /**
     * @override
     * @private
     */
...
const UnitUnitKanbanRenderer = KanbanRenderer.extend({
    config: _.extend({}, KanbanRenderer.prototype.config, {
        KanbanRecord: UnitUnitKanbanRecord,
    }),
});

const ProjectProjectKanbanView = KanbanView.extend({
    config: Object.assign({}, KanbanView.prototype.config, {
        Renderer: UnitUnitKanbanRenderer,
    })
});

viewRegistry.add('unit_unit_kanban', UnitUnitKanbanView);

// TASKS

const UnitGuestKanbanColumn = KanbanColumn.extend({
    /**
     * @override
     * @private
     */
    ...
    _onEditColumn: function (event) {
        ...
        const context = Object.assign({}, this.getSession().user_context, {
            form_view_ref: 'nm_treatment_unit.personal_guest_type_edit',
        });
...
const UnitGuestKanbanRenderer = KanbanRenderer.extend({
    config: Object.assign({}, KanbanRenderer.prototype.config, {
        KanbanColumn: UnitGuestKanbanColumn,
    }),
    ...
    willStart: function () {
        ...
        const isProjectManager = this.getSession().user_has_group('nm_treatment_unit.group_unit_supervisor').then((hasGroup) => {
...
export const UnitKanbanController = KanbanController.extend({
...
const ProjectKanbanView = KanbanView.extend({
    config: _.extend({}, KanbanView.prototype.config, {
        ...
        Controller: UnitKanbanController,
